...
public class CustomExceptionHandler extends ExceptionHandlerWrapper{
	...
	/**
	 * Sobrescreve o metódo handle que é responsavel por manipular as exceções
	 * do JSF
	 */
	@Override
	public void handle() throws FacesException {
		...
		while(iterator.hasNext()){
			...
			try{
				...
				requestMap.put("excepitonMessage", exception.getMessage());
				if(exception != null &&
					...
					org.primefaces.context.RequestContext.getCurrentInstance().showMessageInDialog(new FacesMessage(FacesMessage.SEVERITY_INFO,"Erro", "O sistema se recuperou de um erro inesperado..."));
