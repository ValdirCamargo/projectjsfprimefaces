package br.com.valdir.framework.interfac.crud;
...
public interface InterfaceCrud<T> extends Serializable {
	...
	// Salva ou atualiza
	void saveOrPersist(T obj) throws Exception;

	// Realiza o update/atualização de dados
	void updte(T obj) throws Exception;
	...
	// Carregamento dinamico com jsf PrimeFaces
