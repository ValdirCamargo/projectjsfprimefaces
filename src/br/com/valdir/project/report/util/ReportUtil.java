package br.com.valdir.project.report.util;
...
public class ReportUtil implements Serializable {
	...
	private static final int RELATORIO_PLANILHA_OFFICE = 4;
	...
	public  StreamedContent geraRelatorio(List<?> listDataBeansCollectionReport,
		...
		JRBeanCollectionDataSource jrbcds = new JRBeanCollectionDataSource(listDataBeansCollectionReport);
		...
		case RELATORIO_EXCEL:
			...
			break;
		case RELATORIO_PLANILHA_OFFICE:
